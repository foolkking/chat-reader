...
export function DataBackupPanel() {
  ...
  return (
    <div className="space-y-3 border-t border-ui pt-3">
      ...
      <p className="text-xs leading-5 text-secondary">{zh ? "系统归档恢复请从导入数据入口进行；这里仅负责生成和下载归档。" : "Restore system archives from the Import data entry; this panel only creates and downloads archives."}</p>
