  ...
  return (
    <main className="flex min-h-screen bg-[#f7f7f8] text-[#111827]">
      ...
      <section className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-10 flex h-14 items-center justify-between border-b border-[#e5e5e5] bg-white/95 px-6 backdrop-blur">
          ...
          <button
            ...
            className="rounded-lg bg-[#111827] px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-black focus:outline-none focus:ring-2 focus:ring-[#10a37f]/30"
          >
            + Import
          </button>
        </header>
