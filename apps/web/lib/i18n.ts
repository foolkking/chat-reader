...
const zh = {
  ...
  appearanceLanguage: "外观与语言", theme: "主题", language: "语言", readerWidth: "正文宽度", compact: "窄", standard: "标准", wide: "宽", readerDensity: "Markdown 间距", densityCompact: "紧凑", densityComfortable: "舒适", densityLarge: "宽松", readerFontSize: "正文字号", resetFontSize: "恢复 17px", decreaseFontSize: "减小字号", increaseFontSize: "增大字号", moreSettings: "更多设置", collapseSettings: "收起设置",
