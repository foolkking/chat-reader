...
class ProjectConversation(Base):
    ...
    __table_args__ = (
        UniqueConstraint("project_id", "conversation_id", name="uq_project_conversations_project_conversation"),
        UniqueConstraint("conversation_id", name="uq_project_conversations_conversation"),
    )
