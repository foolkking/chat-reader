...
| RB-002 | Full Online browser/production QA must run from the committed Release B artifact. | Local API/lint/typecheck evidence does not replace CI or production focus verification. The Release B workflow explicitly enables the Share Drawer browser flow. |
