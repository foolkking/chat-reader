...
| CI-013 | CI | Add explicit timeout and artifact collection for every long browser gate. | Strong: first deployment attempt timed out in optional SW readiness. | H | M | Strong | M | L | Completed 2026-08-31; all 15 browser gates have bounded steps and isolated Playwright evidence directories |
