...
- Verification this closure: targeted API `10 passed`; full API `216 passed / 3 skipped`; Web lint/typecheck/build PASS; PWA default `30 passed / 21 skipped`. External image build run `31362680316` and King incremental deployment of `200cf9e` passed checksum, backup, migration and health checks. Conditional online mutation, chooser, two-tab, 360px/zoom, forced-offline negative paths and post-deploy Chrome regression remain explicitly `NOT_PRODUCTION_VERIFIED`.
