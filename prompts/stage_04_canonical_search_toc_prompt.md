# Implementation Prompt: Stage 04 - Canonical 存储、搜索、目录

你现在执行 ChatGPT 导出对话阅读器的 Stage 04。

## 目标

构建 RenderBlock、Heading、SearchDocument 和核心 API。
...
stages/stage_04_canonical_search_toc.md
```
