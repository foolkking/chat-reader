# Implementation Prompt: Stage 06 - Project / Pin / Reading Position

你现在执行 ChatGPT 导出对话阅读器的 Stage 06。

## 目标

实现 Project 管理、置顶、最近打开、继续阅读和阅读范围。
...
stages/stage_06_project_pin_reading_position.md
```
