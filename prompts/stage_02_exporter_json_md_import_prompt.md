# Implementation Prompt: Stage 02 - ChatGPT Exporter JSON + Markdown 导入

你现在执行 ChatGPT 导出对话阅读器的 Stage 02。

## 目标

实现 Exporter JSON/MD parser、aligner、cleaner、canonicalizer。
...
stages/stage_02_exporter_json_md_import.md
```
